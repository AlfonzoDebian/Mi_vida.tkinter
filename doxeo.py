...
# Título y subtítulos
titulo = Label(frame_juego, text="Luis Alfonzo Marquez", fg="White",bg="Black", font=("Arial", 30, "bold"))
titulo.place(x=260, y=5)

# Título y subtítulos
titulo = Label(frame_juego, text="Fecha de Nacimiento: 29 de abril 2007", fg="White",bg="Black", font=("Arial", 15, "bold"))
titulo.place(x=220, y=70)

# Título y subtítulos
titulo = Label(frame_juego, text="Edad: 18 años", fg="White",bg="Black", font=("Arial", 15, "bold"))
